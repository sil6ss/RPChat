...
public class SecondaryChatColorsMenu extends Menu {
    public SecondaryChatColorsMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "§1Secondary Chat Colors";
    }
        ...
        switch (Objects.requireNonNull(inventoryClickEvent.getCurrentItem()).getType()) {
            case BLACK_CONCRETE:
                if (p.hasPermission("rpchat.color.black") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.of("#7a7a7a"));
                    p.closeInventory();
                } else {
            ...
            case BLUE_CONCRETE:
                if (p.hasPermission("rpchat.color.darkblue") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.of("#122ea9"));
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case GREEN_CONCRETE:
                if (p.hasPermission("rpchat.color.darkgreen") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.DARK_GREEN);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case CYAN_CONCRETE:
                if (p.hasPermission("rpchat.color.darkaqua") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.DARK_AQUA);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case RED_CONCRETE:
                if (p.hasPermission("rpchat.color.darkred") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.of("#ad0b0b"));
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case PURPLE_CONCRETE:
                if (p.hasPermission("rpchat.color.darkpurple") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.of("#9a63e2"));
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case ORANGE_CONCRETE_POWDER:
                if (p.hasPermission("rpchat.color.gold") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.GOLD);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case LIGHT_GRAY_CONCRETE:
                if (p.hasPermission("rpchat.color.gray") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.GRAY);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case GRAY_CONCRETE:
                if (p.hasPermission("rpchat.color.darkgray") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.DARK_GRAY);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case BLUE_CONCRETE_POWDER:
                if (p.hasPermission("rpchat.color.blue") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.BLUE);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case LIME_CONCRETE:
                if (p.hasPermission("rpchat.color.green") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.GREEN);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case LIGHT_BLUE_CONCRETE:
                if (p.hasPermission("rpchat.color.aqua") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.AQUA);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case RED_CONCRETE_POWDER:
                if (p.hasPermission("rpchat.color.red") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.RED);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case MAGENTA_CONCRETE:
                if (p.hasPermission("rpchat.color.lightpurple") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.LIGHT_PURPLE);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case YELLOW_CONCRETE:
                if (p.hasPermission("rpchat.color.yellow") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.YELLOW);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
            ...
            case WHITE_CONCRETE:
                if (p.hasPermission("rpchat.color.white") || p.hasPermission("rpchat.color.admin")) {
                    RPChat.getInstance().secondaryRoleplayColors.put(p.getUniqueId(), net.md_5.bungee.api.ChatColor.WHITE);
                    p.closeInventory();
                } else {
                    p.sendMessage(ChatColor.RED + "You have no permission!");
                }
